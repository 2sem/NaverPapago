#
#  Be sure to run `pod spec lint NaverPapago.podspec' to ensure this is a
...
s.description  = <<-DESC
NaverPapago is Pod to call Naver Papago API.
DESC

s.homepage     = "https://github.com/2sem/NaverPapago"
...
s.source       = { :git => "https://github.com/2sem/NaverPapago.git", :tag => "#{s.version}" }
